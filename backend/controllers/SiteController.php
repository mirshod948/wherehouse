...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $totalSales = Yii::$app->db->createCommand('SELECT SUM(total_price) FROM orders WHERE DATE(created_at) = CURDATE()')->queryScalar();

        // Get total number of orders for the day
        $totalOrders = Yii::$app->db->createCommand('SELECT COUNT(*) FROM orders WHERE DATE(created_at) = CURDATE()')->queryScalar();
